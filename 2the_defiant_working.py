...
wb = Workbook()
ws0 = wb.worksheets[0]
ws0.title = 'Author Names and Links'
ws1 = wb.create_sheet()
...
for url in url_list:
    driver.get(url)
    #TODO: Add url.append here to help format excel sheet
...
nested_list = [recent_article_links, author_links, author_names]

ws0.append(nested_list)
...
#! REVISIT HERE
    ...
    #         links = article_title.get_attribute("href")
...
wb.save("2defiant.xlsx")    # Save workbook
